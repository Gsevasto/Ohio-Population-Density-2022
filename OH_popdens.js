...
------------------------------------------------------------------------------------------------------------------------------------------------------*/
     d3.csv("OH_popdens.csv").then(function(populationcsv) {
...
Load json data
------------------------------------------------------------------------------------------------------------------------------------------------------*/
            d3.json("Ohio.geojson").then(function(json) {
            console.log(json);
...
------------------------------------------------------------------------------------------------------------------------------------------------------*/
            for (var j = 0; j < json.features.length; j++){
                var jsonRegionName = json.features[j].properties.name + " " + json.features[j].properties.TYPE;
...
------------------------------------------------------------------------------------------------------------------------------------------------------*/
                    .on("mouseover", function(d){
                        ...
                        .duration(1)	
                        .style("opacity", .9);		
                        tooltip .html(d.properties.name + " " + d.properties.TYPE + "<br>" + "Population Density: " + +d.properties.density.toFixed(2) + " people/square mi")          
...
------------------------------------------------------------------------------------------------------------------------------------------------------*/
            ...
            legend.append('text')
                    ...
                    .attr('y', 16)
                    .text(function(d, i){
                    var ranges = ["1-25", "26-50", "51-100", "101-250", "251-500", "501-1000", "1001-1500", "1501-2000", "2001-2500", ">2500"];
                        return ranges[i] + "   people/square mi";
                    });
        });
